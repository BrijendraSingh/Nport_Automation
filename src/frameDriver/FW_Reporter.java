...
public class FW_Reporter {
	...
	public static void StartReporter(){	
        ...
        if (!file.exists()) {
            if (file.mkdirs()) {
                ...
                FW_Logger.logThis("Extent Reporter", "Initialization", "Done");
                //start extent report
	...
	public static void logPASS(String stepName,String details){
		if(FW_Logger.config.getProperty("ScreenShot_CapturePASS").toString().equalsIgnoreCase("true")){
			date = new Date();
			driver =Aut_Keywords.getdriver();
	...
	public static void logFAIL(String stepName,String details){
		if(FW_Logger.config.getProperty("ScreenShot_CaptureFAIL").toString().equalsIgnoreCase("true")){
			date = new Date();
			driver =Aut_Keywords.getdriver();
			scrFile = ((TakesScreenshot)driver).getScreenshotAs(OutputType.FILE);
			String path = System.getProperty("user.dir")+"\\Results\\Run_"+ResultFolderName+"\\Screenshots\\"+date.toString().replace(" ", "_").replace(":", "_")+".png";
	...
	public static void OpenResult(){
		...
		FirefoxProfile ffprofile = profile.getProfile(FW_Logger.config.getProperty("Firfox_Profile"));
